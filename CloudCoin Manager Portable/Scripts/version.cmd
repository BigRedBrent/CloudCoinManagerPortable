...
PING github.com -n 1 -w 5000 > NUL 2>&1 || GOTO version_almost_done
...
CLS
IF NOT EXIST "%CLOUDCOINMANAGERPORTABLE_home_dir%\Settings\version.tmp" GOTO version_almost_done
...
IF "%CLOUDCOINMANAGERPORTABLE_new_version%" == "" GOTO version_almost_done
IF "%CLOUDCOINMANAGERPORTABLE_version%" == "%CLOUDCOINMANAGERPORTABLE_new_version%" GOTO version_almost_done
...
IF %ERRORLEVEL% == 24 GOTO version_almost_done
