...
IF EXIST "%CLOUDCOINMANAGERPORTABLE_home_dir%\Start CloudCoin Manager Portable.cmd" FOR %%G IN ("%CLOUDCOINMANAGERPORTABLE_home_dir%\*.cmd") DO IF /I NOT "%%~nG" == "Start CloudCoin Manager Portable" (DEL "%%~fG" >NUL 2>&1 & SET CLOUDCOINMANAGERPORTABLE_deleted_cmd=1)
