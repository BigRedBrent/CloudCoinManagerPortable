...
IF EXIST "%CLOUDCOINMANAGERPORTABLE_home_dir%\Settings\custom_end.cmd" (
    START "" wait.vbs "%CLOUDCOINMANAGERPORTABLE_manager_dir%" "%CLOUDCOINMANAGERPORTABLE_manager%" "%CLOUDCOINMANAGERPORTABLE_home_dir%\Settings" "%CLOUDCOINMANAGERPORTABLE_home_dir%\Scripts"
) ELSE (
    START "" /D "%CLOUDCOINMANAGERPORTABLE_manager_dir%" "%CLOUDCOINMANAGERPORTABLE_manager%" -home "%CLOUDCOINMANAGERPORTABLE_home_dir%\Settings"
)
EXIT
