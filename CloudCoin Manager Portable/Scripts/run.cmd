@ECHO OFF
TITLE CloudCoin Manager Portable
IF "%~1" == "" EXIT
CLS
...
SET CLOUDCOINMANAGERPORTABLE_local_userprofile_settings_home_dir=%CLOUDCOINMANAGERPORTABLE_home_dir%\Settings
...
START "" wait.vbs "%CLOUDCOINMANAGERPORTABLE_manager%" "%CLOUDCOINMANAGERPORTABLE_local_userprofile_settings_home_dir%"
EXIT
